...
<div id="nbdesigner_order_info">
	...
	<div class="nbdesigner-right" style="padding: 5px;">
		<?php  if($count_img_design > 0): ?>
			<a href="<?php echo add_query_arg(array('download-all' => 'true', 'order_id' => $order->id), admin_url('admin.php?page=nbdesigner_detail_order')); ?>" class="button button-small button-secondary"><?php _e('Download all', 'nbdesigner'); ?></a>
		<?php else: ?>
