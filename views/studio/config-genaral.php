...
<md-menu-bar class="nbd-menu-bar">
    <md-menu>
        <button  class="md-icon-button" aria-label="Position"  ng-click="$mdMenu.open()">
            <md-icon md-svg-icon="nbd:position" class="bold"></md-icon>
        </button >   
        <md-menu-content>
    ...
    <md-menu>
        <button  class="md-icon-button" aria-label="Rotate"  ng-click="$mdMenu.open()">
            <md-icon md-svg-icon="nbd:rotate" class="bold"></md-icon>
        </button >   
        <md-menu-content>
            <md-menu-item class="md-indent">
                <md-icon md-svg-icon="nbd:reflect-horizontal" class="bold"></md-icon>
            ...
            <md-menu-item class="md-indent">
                <md-icon md-svg-icon="nbd:reflect-vertical" class="bold"></md-icon>
            ...
            <md-menu-item class="md-indent">
                <md-icon md-svg-icon="nbd:one-hundred-eighty" class="bold"></md-icon>
            ...
            <md-menu-item class="md-indent">
                <md-icon md-svg-icon="nbd:ninety-cw" class="bold"></md-icon>
            ...
            <md-menu-item class="md-indent">
                <md-icon md-svg-icon="nbd:ninety-ccw" class="bold"></md-icon>
    ...
    <md-menu>
        <button  class="md-icon-button" aria-label="Arrange"  ng-click="$mdMenu.open()">
            <md-icon md-svg-icon="nbd:arrange" class="bold"></md-icon>
        </button >  
        <md-menu-content>
            <md-menu-item class="md-indent">
                <md-icon md-svg-icon="nbd:bring-front" class="bold"></md-icon>
            ...
            <md-menu-item class="md-indent">
                <md-icon md-svg-icon="nbd:bring-forward" class="bold"></md-icon>
            ...
            <md-menu-item class="md-indent">
                <md-icon md-svg-icon="nbd:send-backward" class="bold"></md-icon>
            ...
            <md-menu-item class="md-indent">
                <md-icon md-svg-icon="nbd:send-back" class="bold"></md-icon>
    ...
    <md-menu>
        ...
        <md-menu-content>
            <md-menu-item class="md-indent">
                <md-icon md-svg-icon="nbd:align-vertical" class="bold"></md-icon>
            ...
            <md-menu-item class="md-indent">
                <md-icon md-svg-icon="nbd:align-left" class="bold"></md-icon>
            ...
            <md-menu-item class="md-indent">
                <md-icon md-svg-icon="nbd:align-right" class="bold"></md-icon>
...
<md-button class="md-icon-button" aria-label="Copy" >
    <md-icon md-svg-icon="nbd:copy" class="bold"></md-icon>
</md-button> 
<md-button class="md-icon-button" aria-label="Delete" onclick="nbdPlg.deleteLayer()">
    <md-icon md-svg-icon="nbd:trash" class="bold"></md-icon>
</md-button>  