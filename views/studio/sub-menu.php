            ...
            <div class="" >
                <div>
                    ...
                    <div class="config-shadow" ng-class="!enableShadow ? 'disabled' : ''">
                        ...
                        <md-slider-container >
                            <md-icon md-svg-icon="nbd:blur">
                                <md-tooltip md-direction="right" ng-class="primaryPalette">Blur</md-tooltip>
                            </md-icon>
                        ...
                        <md-slider-container >
                            <md-icon md-svg-icon="nbd:opacity">
                                <md-tooltip md-direction="right" ng-class="primaryPalette">Opacity</md-tooltip>
                            </md-icon>
