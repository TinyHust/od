...
<div id="config_art" class="shadow od_tab nbdesigner_config" ng-style="{'display': pop.clipArt}">
    <ul class="config_list" id="art_config_list">
        <li ng-show="uiLayout['nbdesigner_clipart_change_path_color'] == 1"><a href="#svg_path"><span class="fa fa-tint" aria-hidden="true"></span></a></li>
        <li><a href="#svg_config"><span class="fa fa-cog" aria-hidden="true"></span></a></li>        
    </ul>
    <div class="list-indicator"></div>
    <div id="svg_path" class="nbdesigner_config_content content" ng-show="uiLayout['nbdesigner_clipart_change_path_color'] == 1">
    ...
    <div id="svg_config" class="nbdesigner_config_content content" style="padding-bottom: 0;">
        <div class="nb-col-30" ng-show="uiLayout['nbdesigner_clipart_rotate'] == 1">
        ...
        <div class="nb-col-30" ng-show="uiLayout['nbdesigner_clipart_opacity'] == 1">
