        ...
        <table class="form-table">
            ...
            <tr valign="top">
                ...
                <td class="forminp-text">
                    ...
                    <a href="javascript:void(0)" onclick="toggleproviderhelp()"><?php _e("Where do I get this info?", $this->textdomain) ?></a>
                </td>
            </tr>	
            <tr valign="top">
            ...
            <tr valign="top" style="display: none;" id="how-to-get-facebook-api">
                <td colspan="2">
                    <div>
                        ...
                        <br />
                        <br />
                        <?php echo sprintf( __('To enable authentication with this provider and to register a new <b>%s API Application</b>, follow the steps', $this->textdomain), 'Facebook' ) ?>
                        :<br />      
                        <div style="margin-left:40px;">
                            ...
                            <p><b>6. </b><?php _e('Go back to the <b>Dashboard</b> page and past the created application credentials (APP ID and Secret) into the boxes above', $this->textdomain)  ?></p>
                        </div>
                        <hr />
                        <div>
                            <p>
