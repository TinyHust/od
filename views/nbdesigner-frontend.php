...
<html lang="en" ng-app="app">
    <head>
        ...
        <link type="text/css" href="<?php echo '../assets/css/jquery-ui.min.css'; ?>" rel="stylesheet" media="all" />
        <link type="text/css" href="<?php echo '../assets/css/font-awesome.min.css'; ?>" rel="stylesheet" media="all" />
        ...
        <link type="text/css" href="<?php echo '../assets/css/bootstrap.min.css'; ?>" rel="stylesheet" media="all"/>
        <link type="text/css" href="<?php echo '../assets/css/bundle.css'; ?>" rel="stylesheet" media="all"/>
        <link type="text/css" href="<?php echo '../assets/css/owl.carousel.css'; ?>" rel="stylesheet" media="all"/>
        <link type="text/css" href="<?php echo '../assets/css/style.min.css'; ?>" rel="stylesheet" media="all">
        <!--[if lt IE 9]>
    ...
    <body ng-controller="DesignerController">
        ...
        <script type="text/javascript" src="<?php echo '../assets/js/touch.js'; ?>"></script>
        ...
        <script type="text/javascript" src="<?php echo '../assets/js/bundle.min.js'; ?>"></script>
        <script type="text/javascript" src="<?php echo '../assets/js/fabric.curvedText.js'; ?>"></script>
        <script type="text/javascript" src="<?php echo '../assets/js/fabric.removeColor.js'; ?>"></script>
        <script type="text/javascript" src="<?php echo '../assets/js/jscolor.min.js'; ?>"></script>
        <script type="text/javascript" src="<?php echo '../assets/js/_layout.js'; ?>"></script>
        <script type="text/javascript" src="<?php echo '../assets/js/designer.min.js'; ?>"></script>		
    </body>
</html>