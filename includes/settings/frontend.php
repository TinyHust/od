            ...
            return apply_filters('nbdesigner_general_settings', array(
                'general-product-designer' => array(
                    array(
                        ...
                        'description' 		=> __( 'Enter a Facebook App-ID to enable Facebook photos in the images module. <a>afda</a>', 'radykal' ),
                ...
                'custom-images' => array(
                    array(
                            ...
                            'id' 		=> 'nbdesigner_type_of_uploader',
                            'default'	=> 'php',
                            'type' 		=> 'radio',
                            ...
                            'relations' => array(
                                    'filereader' => array(
                                            'nbdesigner_upload_designs_php_logged_in' => false,
                                    ),
                                    'php' => array(
                                            'nbdesigner_upload_designs_php_logged_in' => true,
                                    )
                            )
                    ),
