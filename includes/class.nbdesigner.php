        ...
        if(isset($_GET['order_id'])){
            ...
            if(isset($_GET['product_id'])){
                ...
                foreach ($_list_pdfs as $_pdf){
                    ...
                    $list_pdfs[] = array(
                        'title' => basename($_pdf),
                        'url'   =>  Nbdesigner_IO::convert_path_to_url($_pdf)
                    );
                }
    ...
    public function nbd_save_customer_design(){   
        ...
        if (!count($data_after_save_image['mes'])) {              
            ...
            if(($task == 'create_template' || $task == 'edit_template')){
                ...
                WC()->session->set($edit_item . '_nbd_path', json_encode(Nbdesigner_IO::get_list_thumbs($path . '/thumbs')));
    ...
    public function nbdesigner_save_customer_design2() {
        ...
        if(($oid != '')){           
            if(isset($order_design_approve[$index]) && ($order_design_approve[$index] == 'decline')){          
                ...
                $result['redesign'] = __("Your design has been approved or pendding to review!", 'web-to-print-online-designer');
            }
        }
        echo json_encode($result);
        wp_die();
