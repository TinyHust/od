...
angular.module("app").service("ProductService", function($http, $q) {
    this.getProduct = function(id, variation) {
        ...
        $http({
            url: window.parent.nbds_frontend.url,
            method: "POST",
            data: "action=nbdesigner_get_product_info&nonce=" + window.parent.nbds_frontend.nonce + "&id=" + product_id + "&oid=" + orderid + '&did=' + id + '&variation=' + variation,
            headers: {
