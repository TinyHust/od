...
angular.module("app").controller("DesignerController", function($scope, PatternService, ProductService, localStorageService, FontService, ArtService, QrcodeService, $interval, $upload, $timeout, LanguageService, AdminTemplateService) {
    ...
    $scope.saveDesign = function(orientation) {
        ...
        $scope.zoomCanvas();
        $scope.drawCanvas();
        var svg = canvas.deactivateAll().toDataURL('jpg');
    ...
    $scope.instagramRedirect = 'http://dev.cmsmart.net:3000/wp46/wp-content/plugins/nbdesignerv130/includes/auth-instagram.php';
    ...
    $scope._authenticateInstagram = function(){
        ...
        var url = 'https://instagram.com/oauth/authorize/?client_id='+NBDESIGNCONFIG['nbdesigner_instagram_app_id']+'&redirect_uri='+$scope.instagramRedirect+'&response_type=token';
